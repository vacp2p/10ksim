...
class PanelProcessor(DatasetProcessor):
    ...
    def process_panel(self, experiment_id: str, panel_config: PanelConfig) -> bool:
    ...
    def process_experiment_panels(self, experiment: ExperimentConfig, max_workers: int = 4) -> int:
    ...
    def _apply_derive_transformations(
        self, data: List[Dict[str, Any]], panel_config: PanelConfig
    ) -> List[Dict[str, Any]]:
    ...
    def _transform_to_timeseries(
        ...
        if transform.groupBy:
            ...
            for row in data:
                ...
                if x_val is not None and y_val is not None:
                    ...
                    grouped_series[group_key].append(
                        {"timestamp": x_val_serialized, "value": float(y_val)}
                    )
            ...
            if transform.top:
                ...
                top_series = dict(
                    (name, points) for name, _, points in series_stats[: transform.top]
                )
        ...
        option = {
            ...
            "title": {
                ...
                "left": "center",
                "top": 10,
                "textStyle": {"color": "#152521", "fontSize": 16, "fontWeight": "normal"},
            },
            "tooltip": {
                "trigger": "axis",
                "axisPointer": {
                    "type": "line",
                    "lineStyle": {"color": "#b8bdb8", "type": "dashed"},
                },
                "backgroundColor": "rgba(245, 245, 239, 0.95)",
                "borderColor": "#dbddd7",
                "borderWidth": 1,
                "textStyle": {"color": "#152521", "fontSize": 12},
                "confine": True,
            },
            "legend": {
                "type": "scroll",
                ...
                "bottom": 5,
                "left": "center",
                "textStyle": {"color": "#475651", "fontSize": 11},
                "pageIconColor": "#5470c6",
                "pageIconInactiveColor": "#dbddd7",
                "pageTextStyle": {"color": "#475651"},
                "icon": "roundRect",
            },
            "toolbox": {
                "show": True,
                ...
                "iconStyle": {"borderColor": "#848e88"},
                "emphasis": {"iconStyle": {"borderColor": "#5470c6"}},
                "top": 10,
                "right": 20,
            },
            ...
            "xAxis": {
                "type": "time",
                "boundaryGap": False,
                "axisLabel": {"color": "#475651", "fontSize": 11, "formatter": "{HH}:{mm}"},
                "axisLine": {"lineStyle": {"color": "#b8bdb8"}},
                "axisTick": {"show": False},
            ...
            "yAxis": {
                "type": "value",
                "axisLabel": {"color": "#475651", "fontSize": 11},
                "axisLine": {"show": False},
                "axisTick": {"show": False},
                "splitLine": {"lineStyle": {"color": "#eceee4", "type": "solid"}},
            },
            "series": series,
        }
    ...
    def transform_panel_data(
        self, experiment_id: str, panel_config: PanelConfig, viz_format: str = "echarts"
    ) -> Dict[str, Any]:
    ...
    def _transform_to_echarts(
        ...
        if panel_config.type == "boxplot":
            ...
            return {"type": "table", "title": panel_config.title, "data": data}
        else:
