...
if __name__ == "__main__":
    ...
    log_analyzer = WakuAnalyzer(
        dump_analysis_dir="local_data/simulations_data/refactor_nimlibp2p/",
    ...
    waku_plots.plot_message_distribution(
        Path("local_data/simulations_data/refactor/summary/received.csv"),
        "Title",
    ...
    log_analyzer.analyze_reliability(n_jobs=4)
    waku_plots.plot_message_distribution_libp2pmix(
