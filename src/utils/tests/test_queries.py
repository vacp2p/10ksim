...
class TestQueries(unittest.TestCase):
    ...
    def test_get_query_data_correct(self, mock_requests_get):
    ...
    def test_get_query_data_timeout(self, mock_requests_get):
    ...
    def test_get_query_data_error(self, mock_requests_get):
